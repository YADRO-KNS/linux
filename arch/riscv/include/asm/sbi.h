...
enum sbi_pmu_fw_generic_events_t {
	...
	/** Some testing event codes */
	SBI_PMU_FW_SHADOW_CPU_CYCLES		= 22,
	SBI_PMU_FW_SHADOW_INSTRUCTIONS		= 23,
	SBI_PMU_FW_MACHINE_CYCLES		= 24,
	SBI_PMU_FW_MACHINE_INSTRUCTIONS		= 25,
